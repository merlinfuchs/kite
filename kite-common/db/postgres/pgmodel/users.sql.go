...
const upserUser = `-- name: UpserUser :one
INSERT INTO users (
    id,
    email,
    display_name, 
...
func (q *Queries) UpserUser(ctx context.Context, arg UpserUserParams) (User, error) {
	row := q.db.QueryRow(ctx, upserUser,
		arg.ID,
		arg.Email,
		arg.DisplayName,
		arg.DiscordID,
