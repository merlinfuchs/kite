...
type CommandStore interface {
	...
	// CommandsUpdatedSince includes disabled commands, except for the zero
	// time.
	CommandsUpdatedSince(ctx context.Context, updatedSince time.Time) ([]*model.Command, error)
