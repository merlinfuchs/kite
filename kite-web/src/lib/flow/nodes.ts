...
import {
  ...
  nodeActionInviteCreateDataSchema,
...
import {
  ...
  nodeActionInviteCreateResultSchema,
...
export const nodeTypes: Record<string, NodeValues> = {
  ...
  action_invite_create: {
    color: actionColor,
    icon: "link",
    defaultTitle: "Create invite",
    defaultDescription: "Create an invite for the channel this ran in",
    dataSchema: nodeActionInviteCreateDataSchema,
    resultSchema: nodeActionInviteCreateResultSchema,
    dataFields: [
      "channel_target",
      "invite_data",
      "audit_log_reason",
