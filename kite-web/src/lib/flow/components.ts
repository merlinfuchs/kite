...
import FlowNodeActionResponse from "@/components/flow/FlowNodeActionResponse";
...
export const nodeTypes = {
  ...
  action_response_create: FlowNodeActionResponse,
  action_response_edit: FlowNodeActionResponse,
