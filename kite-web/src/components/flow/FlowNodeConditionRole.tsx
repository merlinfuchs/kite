...
import { NodeProps, NodeType } from "../../lib/flow/dataSchema";
...
export default function FlowNodeConditionRole(props: NodeProps) {
  ...
  function addItem() {
    ...
    const [newNodes, newEdges] = createNode("control_condition_item_role", {
